...
def drive_callback(data, state):
    ...
    if velocity >= 0.5:
        ...
        velocity = 0.5
    speed_msg = Float32(velocity)
    turn_msg = Float32(angle)
    speed_pub.publish(speed_msg)
    turn_pub.publish(turn_msg)
    print("Velocity: ", speed_msg.data, "Angle: ", turn_msg.data)
...
if __name__ == '__main__':
    ...
    speed_pub = rospy.Publisher('commands/motor/duty_cycle', Float32, queue_size=10)
    turn_pub = rospy.Publisher('commands/servo/position', Float32, queue_size=10)
